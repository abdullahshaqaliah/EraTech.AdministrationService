...
using EraTech.Shared.Hosting.Microservices.DbMigrations.EfCore;
...
namespace EraTech.AdministrationService.DbMigrations;
    ...
    : PendingEfCoreMigrationsChecker<AdministrationServiceDbContext>
{
    ...
    private async Task SeedDataAsync()
    {
        using (var uow = UnitOfWorkManager.Begin(requiresNew: true, isTransactional: true))
        {
            ...
            var permission = await _permissionDefinitionManager.GetPermissionsAsync().ConfigureAwait(false);
